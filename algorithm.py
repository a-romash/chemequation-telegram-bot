...
def get_coef(reactants, products):  # Создание строки, с расставленными коэффициентами
    elementList = []
    elementMatrix = []
    reactants, products = reactants, products
    reactants = reactants.replace(' ', '').split("+")  # Ca(OH)2+H3PO4
    products = products.replace(' ', '').split("+")  # Ca3(PO4)2+H2O
